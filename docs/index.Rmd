...
- Download the syllabus: https://github.com/amandamartinsal/EDSD_kinship/blob/master/EDSD_2024_syllabus.pdf
- The course's slides are available here: https://github.com/amandamartinsal/EDSD_kinship/tree/master/slides
...
```{r 59, warning=F, message=FALSE, include=FALSE}
# load function
source("UNWPP_data.R")
...
- One-sex model; approximate male kin using GKP factors
     ...
     - time-variant rates
- One-sex model; approximate male kin using the androgynous assumption
     - time-invariant rates
     - time-variant rates
...
> If you choose work with time-variant rates, you need population data for the argument "n". Please download the data [here](https://population.un.org/wpp/Download/Files/1_Indicators%20(Standard)/CSV_FILES/WPP2022_Population1JanuaryBySingleAgeSex_Medium_1950-2021.zip).
