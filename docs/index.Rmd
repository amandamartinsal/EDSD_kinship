...
- Download the syllabus: https://github.com/alburezg/EDSD_2023_kinship_demography/blob/main/EDSD_2023_kinship.pdf [UPDATE WITH THE FINAL VERSION]
- The course's slides are available here: https://github.com/alburezg/EDSD_2023_kinship_demography/tree/main/slides [UPDATE WITH DIEGOS SLIDES]
- Find this website's source code on GitHub: https://amandamartinsal.github.io/EDSD_24_kinship
...
We can estimate rates from any country in the world, produced by the World Population Prospects project. Pick any country (feel free to pick at random or pick the one you are interested in) and download the following data from:
   ...
   -  [Fertility, 1950 - 2100](https://population.un.org/wpp/Download/Files/1_Indicators%20(Standard)/CSV_FILES/WPP2022_Fertility_by_Age1.zip)
   
   -  Life Tables, 1950 - 2021:
   [Females](https://population.un.org/wpp/Download/Files/1_Indicators%20(Standard)/CSV_FILES/WPP2022_Life_Table_Complete_Medium_Female_1950-2021.zip)
   [Males](https://population.un.org/wpp/Download/Files/1_Indicators%20(Standard)/CSV_FILES/WPP2022_Life_Table_Complete_Medium_Male_1950-2021.zip)
   
In the materials in the Github repositories you downloaded for this course, there is a folder called docs:
...
br_2015$kin_summary %>%
  ...
  theme_bw()
```
sing only the raw output in `kin_full`:

##### 3.2.1 Get then mean age of living mother, daughter and sisters for a female aged 35.
...
For this exercise, you should use `DemoKin` and choose one country and at least two of the specifications shown below. 

###### 1 Specifications of the kinship model:
       (a) One-sex model; approximate male kin using GKP factors
        i. time-invariant rates
        ii. item time-variant rates
       (b) One-sex model; approximate male kin using the androgynous assumption
        i. time-invariant rates
        ii. item time-variant rates
        
###### 2 Plot the **expected number of living relatives** and the **expected number of deceased relatives** for each specification you selected. 
###### 3 Discuss 1-2 key insights, when would you use different specifications? (max 250 words)
###### 4 Considering the male fertility options we looked at during the course: What other approaches would you suggest? (max 250 words)
